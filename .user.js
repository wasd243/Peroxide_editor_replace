(function () {
    ...
    // 编辑器部署地址，替换为你的 GitHub Pages URL
    var EDITOR_URL = 'https://your-name.github.io/SCP-Foundation-editor-web/';
    ...
    iframe.addEventListener('load', function () {
        iframe.contentWindow.postMessage({
            type: 'h2o2-init',
            payload: nativeTextarea.value  // 编辑已有页面时的初始内容
        }, '*');
    });
    ...
    window.addEventListener('message', function (event) {
        ...
        // 安全检查：只接受来自你编辑器域名的消息（生产环境建议启用）
        // if (event.origin !== 'https://your-name.github.io') return;
